    ...
    for data_source, uid2var2vals in data_src2uid2var2vals.items():
        ...
        for uid, var2vals in uid2var2vals.items():
            ...
            for var_name, var_vals in var2vals.items():
                # Reward extra-info may contain non-metric payloads such as
                # optional teacher feedback (a mixture of strings and None).
                # Only aggregate numeric scalar fields. Checking only the
                # first value is insufficient: a correct rollout can have
                # feedback=None while another rollout has a feedback string.
                if not var_vals or not all(
                    isinstance(value, (int, float, np.number, bool))
