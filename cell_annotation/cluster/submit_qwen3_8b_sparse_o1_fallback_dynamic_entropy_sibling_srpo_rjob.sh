...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen3-8b-paper10ep-sparse-o1-fallback-dw-sibling-k8-5ep-seed0}
JOB_NAME=${JOB_NAME:-qwen3-8b-sparse-o1-dw-sibling-v1}

export EXPERIMENT_NAME JOB_NAME
export CONFIG_NAME=${CONFIG_NAME:-o1_fallback_dynamic_entropy_sibling_srpo}
export DATA_DIR=${DATA_DIR:-${REPO_DIR}/cell_annotation/data/rl_thinking_o1_privileged/processed}
export REWARD_FN_NAME=${REWARD_FN_NAME:-compute_sparse_o1_fallback_sibling_score}
