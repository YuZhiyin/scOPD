...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen3-8b-nt-rsft10ep-dense-sibling-nodw-k8-5ep-seed0}
JOB_NAME=${JOB_NAME:-qwen3-8b-nt-dense-sibling-nodw-v1}
...
export CONFIG_NAME=${CONFIG_NAME:-nonthinking_reasoning_sibling_srpo}
export REWARD_FN_NAME=${REWARD_FN_NAME:-compute_nonthinking_reasoning_repo_sibling_score}
...
export DYNAMIC_ENTROPY_WEIGHTING=False
...
export ACTOR_CHECKPOINT_SAVE_CONTENTS=${ACTOR_CHECKPOINT_SAVE_CONTENTS:-"['model']"}
