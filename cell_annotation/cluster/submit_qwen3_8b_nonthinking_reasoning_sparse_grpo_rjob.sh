...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen3-8b-nt-rsft10ep-sparse-grpo-k8-5ep-seed0}
JOB_NAME=${JOB_NAME:-qwen3-8b-nt-sparse-grpo-k8-5ep-v1}
...
export REWARD_FN_NAME=${REWARD_FN_NAME:-compute_nonthinking_reasoning_sparse_score}
