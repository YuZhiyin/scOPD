...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen3-8b-nt-rsft10ep-dense-sibling-o1-nodw-k8-5ep-seed0}
JOB_NAME=${JOB_NAME:-qwen3-8b-nt-dense-sibling-o1-nodw-v1}
...
export CONFIG_NAME=${CONFIG_NAME:-nonthinking_reasoning_o1_fallback_sibling_srpo}
