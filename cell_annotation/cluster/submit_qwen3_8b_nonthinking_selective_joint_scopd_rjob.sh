...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen3-8b-nt-selective-joint-scopd-lam03-k8-5ep-seed0}
JOB_NAME=${JOB_NAME:-qwen3-8b-nt-selective-joint-scopd-l03-v1}
...
export CONFIG_NAME=${CONFIG_NAME:-nonthinking_reasoning_selective_joint_scopd}
export REWARD_FN_NAME=${REWARD_FN_NAME:-compute_nonthinking_reasoning_repo_o1_fallback_sibling_score}
export ENABLE_THINKING=false
export LOSS_MODE=selective_joint_grpo_sdpo
