...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen3-8b-nt-rsft10ep-joint-hier-srcw-reason-dw-k8-5ep-seed0}
JOB_NAME=${JOB_NAME:-qwen3-8b-nt-joint-hier-srcw-reason-dw-v1}
...
export CONFIG_NAME=${CONFIG_NAME:-nonthinking_reasoning_joint_hierarchical_source_reasoning_sdpo}
export REWARD_FN_NAME=${REWARD_FN_NAME:-compute_nonthinking_reasoning_joint_hierarchical_score}
