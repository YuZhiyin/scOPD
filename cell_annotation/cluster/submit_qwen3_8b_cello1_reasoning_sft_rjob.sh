...
RUN_SCRIPT="${REPO_DIR}/cell_annotation/cluster/run_qwen3_8b_cello1_reasoning_sft_rjob.sh"
...
CMD=(
    ...
    -e GRADIENT_ACCUMULATION_STEPS="${GRADIENT_ACCUMULATION_STEPS:-12}"
    -e MAX_LENGTH="${MAX_LENGTH:-4096}"
    -e LORA_R="${LORA_R:-256}"
