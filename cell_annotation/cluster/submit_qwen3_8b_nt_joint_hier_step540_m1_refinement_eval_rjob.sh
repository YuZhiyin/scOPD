...
export RUN_TS
export JOB_NAME=${JOB_NAME:-qwen3-8b-nt-joint-hier-m1-refine}
...
export OUTPUT_DIR=${OUTPUT_DIR:-${REPO_DIR}/outputs/cell_annotation/eval_qwen3_8b_nt_joint_hier_step540_m1_refinement_${RUN_TS}}
