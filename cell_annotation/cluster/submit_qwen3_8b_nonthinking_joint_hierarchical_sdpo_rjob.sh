...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen3-8b-nt-rsft10ep-joint-dense-hier-dw-lam03-k8-5ep-seed0}
JOB_NAME=${JOB_NAME:-qwen3-8b-nt-joint-hier-lam03-v1}
...
export CONFIG_NAME=${CONFIG_NAME:-nonthinking_reasoning_joint_hierarchical_sdpo}
