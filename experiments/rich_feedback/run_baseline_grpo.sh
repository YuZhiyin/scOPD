...
LRS=(1e-6)
MODEL_PATHS=(
    "/mnt/shared-storage-user/ma4tool-shared/hug_ckpts/Qwen3/Qwen3-8B"
)
...
pip install -e /mnt/shared-storage-user/yuzhiyin/SDPO; \
pip install --upgrade wandb; \
export WANDB_MODE=offline; \
export PYTHONPATH=/mnt/shared-storage-user/yuzhiyin/SDPO:$PYTHONPATH"

    local run_cmd="bash /mnt/shared-storage-user/yuzhiyin/SDPO/training/verl_training.sh $exp_name $CONFIG_NAME $data_path $script_args"
    ...
    local sbatch_cmd=(
        ...
        --output="/mnt/shared-storage-user/yuzhiyin/output/SDPO/%j.log"
        --error="/mnt/shared-storage-user/yuzhiyin/output/SDPO/%j.err"
        --wrap="$wrapped_cmd"
    )
